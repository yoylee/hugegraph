...
public class CompressUtilTest {
    ...
    public void testZipCompress() throws IOException {
        ...
        try {
            ...
            ZipUtil.compress(rootDir, sourceDir, zipFile, checksum);

            ZipUtil.decompress(zipFile, output, checksum);
    ...
    public void testTarCompress() throws IOException {
        ...
        try {
            ...
            Checksum checksum = new CRC64();
            TarLZ4Util.compress(rootDir, sourceDir, tarFile, checksum);

            TarLZ4Util.decompress(tarFile, output, checksum);
            assertDirEquals(rootDir, output);
        } finally {
            FileUtils.deleteQuietly(new File(rootDir));
